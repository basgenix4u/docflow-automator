  ...
  return (
    <header className="h-16 border-b border-emerald-800/60 bg-emerald-950/90 backdrop-blur px-6 flex items-center justify-between sticky top-0 z-50">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="flex items-center space-x-2 text-xs text-emerald-100 bg-emerald-900/40 px-3 py-1.5 rounded-md border border-emerald-800">
          <ShieldCheck className="w-4 h-4 text-emerald-400" />
          <span className="font-mono">Zero Session Lockouts Active</span>
        </div>
      </div>
    </header>
  );
