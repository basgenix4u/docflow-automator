...
export default function DocumentsPage() {
  ...
  const [renderTitle, setRenderTitle] = useState("FUW Student Verification Report — REDACTED_USERNAME");
...
<body>
  ...
  <div class="card">
    ...
    <p><span class="label">Matriculation No:</span> REDACTED_USERNAME</p>
