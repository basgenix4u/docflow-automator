...
async def test_isolated_exam_card_a5():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            print(f"Captured Popup Target URL: {target_page.url}")

            # Hide unneeded navigation header/sidebars/scripts so ONLY the Exam Card div (#contents) is rendered
...
if __name__ == "__main__":
    asyncio.run(test_isolated_exam_card_a5())
