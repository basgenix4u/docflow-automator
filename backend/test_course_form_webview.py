...
async def run_course_form_exact_a4(
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            print("--> Navigating to Print Course Form (print_course_form.php?id=crg&r_val=U3R1ZGVudA==)...")
            ...
            # Wait for JS / Images / Fonts to finish
            ...
            # Measure document.scrollWidth / scrollHeight
            ...
            # Set PDF page = A4 (210 x 297 mm) -> ~1075px printable height
...
if __name__ == "__main__":
    asyncio.run(run_course_form_exact_a4(os.environ.get("FUW_PORTAL_USERNAME", ""), os.environ.get("FUW_PORTAL_PASSWORD", ""), "FUW_1Page_CourseForm_ENG_COE_21_013_A4.pdf"))
