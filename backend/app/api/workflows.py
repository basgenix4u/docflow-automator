...
async def run_workflow(
    ...
    demo_user = (req.custom_username if req and req.custom_username else None) or (portal.demo_username if portal else "REDACTED_USERNAME")
    demo_pass = (req.custom_password if req and req.custom_password else None) or (portal.demo_password if portal else "REDACTED_PASSWORD")
